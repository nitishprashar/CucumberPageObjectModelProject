...
import com.myOrganization.pages.pages_actions.UsedCarsSearchPageActions;
...
public class StepDefinationUsedCarSearch {
	...
	public void click_on_submenu_Used_Cars_Search_link()  {
		carsGuideHomePageActions.clickOnUsedCarslink();
	}
